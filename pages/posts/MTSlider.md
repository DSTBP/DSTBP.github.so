...
var zo = function ze(zy) {
    try {
        var zG = JSON["stringify"](zy);
        return window["btoa"](encodeURIComponent(zG));
    } catch (zF) {
...
![](/images/pages/mtslider/img8.png)
...
![](/images/pages/mtslider/img9.png)
...
![](/images/pages/mtslider/img10.png)
...
class MeiTuanLogin:
    ...
    def main(self):
        ...
        rohrToken = self.MT.get_rohrtoken(token_data, timestamp)
...
# 加载JS
def execute_js_function(script_name, function_name, *args):
    try:
        with open(f'./{script_name}.js', 'r', encoding='utf8') as file:
            js_code = file.read()
            ctx = execjs.compile(js_code)
            result = ctx.call(function_name, *args)
            return result
    except execjs.ProgramError as e:
        logger.error(f"Error occurred in {function_name}: {e}")
        return None
...
class MeituanData:
    ...
    def get_enc_data(self, pt, general, name):
        return execute_js_function('encrypt', 'gen_behavior_token', pt, general, name)
    ...
    def get_behavior(self, ts: int) -> dict:
        pool = [
            ...
            [[0, 83, 172, 597], [0, 95, 172, 619], [0, 104, 172, 626], [0, 113, 172, 635], [0, 124, 172, 642],
             [0, 136, 172, 651], [0, 148, 172, 658], [0, 161, 172, 666], [0, 173, 172, 675], [0, 186, 173, 682],
             [0, 198, 173, 690], [0, 210, 173, 698], [0, 222, 173, 706], [0, 233, 174, 715], [0, 242, 174, 723],
             [0, 250, 174, 730], [0, 254, 174, 738], [0, 257, 174, 746], [0, 260, 174, 754], [0, 262, 174, 762],
             [0, 264, 174, 771], [0, 267, 174, 778], [0, 269, 174, 787], [0, 272, 173, 794], [0, 275, 173, 802],
             [0, 278, 173, 811], [0, 281, 173, 818]],....
        ]
        trajectory = {
    ...
    def get_token(self, trajectory_point: str, _user_agent: str, ts: int) -> dict:
        ...
        msg = {
            ...
            "aF": "",
            "wI": "2218542028",
            "wC": '{"platform":"Linux armv81","userAgent": "' + _user_agent + '","contextName":"webgl2","glVersion":...',
